...
SELECT COUNT(id) as numberOFIDS FROM intro_sql.final_airbnb;
...
Select avg(availability_365) as Average_Availability from intro_sql.final_airbnb;
...
Select id as Listing_ID from intro_sql.final_airbnb 
	where last_review = ""; 
